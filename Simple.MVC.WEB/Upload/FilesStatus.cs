...
namespace jQuery_File_Upload.MVC3.Upload
{
    public class FilesStatus
    {
        ...
        public FilesStatus(string fileName, int fileLength, string fullPath, string fullPathThumb) { SetValues(fileName, fileLength, fullPath, fullPathThumb); }

        private void SetValues(string fileName, int fileLength, string fullPath, string fullPathThum="")
        {
            name = fileName;
            type = "image/png";
            size = fileLength;
